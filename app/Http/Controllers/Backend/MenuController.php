...
class MenuController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        notify()->success('Menu Created Successfully', 'Success');
    ...
    public function update(Request $request, Menu $menu)
    {
        ...
        notify()->success('Menu Update Successfully', 'Success');
        return redirect()->route('app.menus.index');
    }
    ...
    public function destroy(Menu $menu)
    {
        ...
        if ($menu->deletable == true){
            $menu->delete();
            notify()->success('Menu Delete Successfully', 'Success');
        }else{
            notify()->error("Error notification test","Error");
        }
        return back();
    }
}
