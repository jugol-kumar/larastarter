                        ...
                        <div class="widget-content-left">
                            <div class="btn-group">
                                ...
                                <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a href="{{ route('app.profile.password.change') }}" type="button" tabindex="0" class="dropdown-item">Change Password</a>
                                    <button type="button" tabindex="0" class="dropdown-item">Setting</button>
                                    <div tabindex="-1" class="dropdown-divider"></div>
                                    <button type="button" tabindex="0" class="dropdown-item"
                                            onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();">Sing Out</button>
