            ...
            <div class="row mb-5">
                ...
                <div class="col-md-3">
                    <div class="list-group">
                        ...
                        <a href="#" class="list-group-item list-group-item-action">Mail Setup</a>
                        <a href="#" class="list-group-item list-group-item-action">Website Settings</a>
                    </div>
                </div>
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input id="site_title" type="text" class="form-control @error('site_title') is-invalid @enderror"
                                           name="site_title" value="{{ 'site_title' ?? old('site_title') }}" required autofocus>
                                    @error('site_title')
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="site_description" type="text" class="form-control @error('site_Description') is-invalid @enderror"
                                              name="site_description" required autofocus>{{ 'site_Description' ?? old('site_Description') }} </textarea>
